...
> # 2024.12.21
>
> - "송금하기" 부분 출금계좌 선택하면 이체할 계좌번호를 입력할수있게 활성화 작업
> - "송금하기" 부분 이체할 계좌번호를 적으면 13자리인지 체크, 존재하는 계좌인지 체크 후 이체할 금액을 선택할수 있게 ajax 처리 및 입력칸 활성화
> - "송금하기" 부분 이체금액까지 적는다면 본인이 출금 계좌의 비밀번호 입력칸 활성화
> - "송금하기" 부분 모든작성이 끝난 후 계좌비밀번호 4자리를 적는다면 패스워드가 4글자인지 확인 후 출금계좌의 패스워드와 동일한지 ajax로 체크 이후 송금하기 버튼활성화 작업예정
