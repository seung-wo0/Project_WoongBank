...
>   - [ ] 모든 계좌 리스트에서 현재잔액도 볼 수 있게 추가작업 예정
> - **입·출금, 송금 및 거래내역 조회**
>   - [ ] 입·출금 은 본인계좌로만 가능하게
>   - [ ] 입·출금 페이지내에서 select로 입·출금 중 선택, 이후 ajax(비동기) 로 해당관련 맞는 데이터를 불러와 작업 예정
>   - [ ] 입·출금 공통작업 중 계좌를 선택 하면 역시 ajax 로 선택한 계좌에대한 금액등을 불러와 입금하려는금액을 입력하면 예상 계좌잔액 으로 표기
...
> # DB 설계도
>
> <img src="https://github.com/user-attachments/assets/af6759af-5fb6-44f5-9882-c1a44452e48b" width="100%" title="DB 설계도" />
